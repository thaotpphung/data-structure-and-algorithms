...
Space complexity : O(1)O. Space depends on the sorting implementation which, usually, costs O(1) auxiliary space if heapsort is used.
*/
...
Space complexity : O(n)O. The space used by a hash table is linear with the number of elements in it.
*/